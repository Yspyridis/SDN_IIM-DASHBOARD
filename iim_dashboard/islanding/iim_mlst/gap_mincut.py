...
# START
# start = input('Kafka event received, initiate islanding? (y/n): ')
# if start == 'n':
#     sys.exit('Aborting')
...
# print(type(net))
# net = requests.get('http://10.100.221.121:8888/model').text
# print(type(net))
# json_response = requests.get('http://10.100.221.121:8888/model_ALL_DER').json()
# net = pp.from_json_dict(json_response)
# print(requests.get('http://10.100.221.121:8888/measurements').json())
...
# simple_plotly_gen(net, file_name='islanding/iim_mlst/static/grid_initial/interactive-plot_before.html')
pp.plotting.to_html(net, filename='islanding/iim_mlst/static/grid_initial/interactive-plot_before.html', show_tables=False)
